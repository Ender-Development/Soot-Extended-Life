...
public class Attributes {
    public static final IAttribute PHYSICAL_DAMAGE_RATE = new RangedAttribute(null, "soot.physicalDamageRate", 1.0D, 0.0D, 2048.0D);
    public static final IAttribute EXPERIENCE_RATE = new RangedAttribute(null, "soot.experienceRate", 1.0D, 0.0D, 2048.0D);
    public static final IAttribute FIRE_DAMAGE_RATE = new RangedAttribute(null, "soot.fireDamageRate", 1.0D, 0.0D, 2048.0D);
    public static final IAttribute FIRE_ASPECT = new RangedAttribute(null, "soot.fireAspect", 0.0D, 0.0D, 72000.0D);
